...
void roipool_forward_cpu( at::Tensor data, at::Tensor rois, at::Tensor roibatches,
...
void roipool_backward_cpu( at::Tensor crop_diff, at::Tensor argmax, at::Tensor rois,
...
{
    m.def("forward", &roipool_forward_cpu, "Roipool Forward");
    m.def("backward", &roipool_backward_cpu, "Roipool Backward");
}
