...
class MixRCNNBBox(torch.nn.Module):
    def __init__(self, backbone, heads, neck=None, targets_converter=None, inputs_converter=None, cfg=None, second_loss_weight=None,expand_ratio=None, test_mode='both', debug_time=False):
        super().__init__()
    ...
    def forward(self, inputs, targets=None):
        ...
        if self.training:
            ...
            losses_second_roi = self.bbox_head(features, human_proposal, stride_second, inputs=inputs, targets=targets )
