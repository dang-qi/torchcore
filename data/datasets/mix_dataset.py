...
class MixDataset(Dataset):
    def __init__(self, dataset_a, dataset_b, shuffle=False, sample=None, transforms_a=None, transforms_b=None, add_dataset_label=False):
